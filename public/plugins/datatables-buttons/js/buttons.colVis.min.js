/*!
 ...
 ("buttons.colvis","Column visibility")
*/
...
init:function(f,k){c=k},text:function(f){return f.i18n("buttons.colvis","เลือกข้อมูลที่ต้องการแสดง")},className:"buttons-colvis",closeButton:!1,buttons:[{extend:"columnsToggle",columns:a.columns,columnText:a.columnText}]};b.on("column-reorder.dt"+a.namespace,function(f,k,m){b.button(null,b.button(null,c).node()).collectionRebuild([{extend:"columnsToggle",columns:a.columns,columnText:a.columnText}])});return d},columnsToggle:function(b,a){return b.columns(a.columns).indexes().map(function(c){return{extend:"columnToggle",
