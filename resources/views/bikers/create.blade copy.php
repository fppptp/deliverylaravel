                                    ...
                                    <form method="POST" action="{{ route('bikers.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="text-sm">แสดงรูปตัวอย่าง</label>
                                                        <img id="blah" src="#" alt=""
                                                            width="300px" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group row mb-1">
                                                    <label for="fullname"
                                                        class="col-md-3 col-form-label text-md-right">ชื่อ-นามสกุล</label>
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="idcard"
                                                        class="col-md-3 col-form-label text-md-right">เลขประจำตัวประชาชน</label>
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="gender"
                                                        class="col-md-3 col-form-label text-md-right">เพศ</label>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="birthday"
                                                        class="col-md-3 col-form-label text-md-right">วันเดือนปีเกิด</label>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="registrationplate"
                                                        class="col-md-3 col-form-label text-md-right">ทะเบียนรถที่ใช้</label>
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="brand"
                                                        class="col-md-3 col-form-label text-md-right">ยี่ห้อรถ</label>
                                                ...
                                                <div class="form-group row mb-1">
                                                    <label for="color"
                                                        class="col-md-3 col-form-label text-md-right">สีรถ</label>
                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-md-2">
                                                <input id="registrationplate" type="text"
                                                    class="form-control @error('registrationplate') is-invalid @enderror"
                                                    name="registrationplate" value="{{ old('registrationplate') }}"
                                        ...
                                        <div class="form-group row mb-1">
                                            <label for="image"
                                                class="col-md-3 col-form-label text-md-right">รูปถ่ายพนักงานขับรถ</label>
                                            <div class="col-md-4">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="image123"
                                        ...
                                        <div class="form-group row mb-1">
                                            <label class="col-md-3 col-form-label text-md-right">แสดงรูปที่อัพโหลด</label>
                                            <div class="col-md-4">
                                                <img id="blah123" src="#" alt="your image" width="200px" />
                                            </div>
                                        </div>
