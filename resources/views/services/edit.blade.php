                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <center>กรุณาตรวจสอบข้อมูลการจัดส่งก่อนระบบในระบบ</center>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="customer_fullname" type="text"
                                                                    ...
                                                                    value="{{ old('customer_fullname', $service->customer_fullname) }}"
                                                                    required autocomplete="customer_fullname" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="customer_phone" type="text"
                                                                    ...
                                                                    required autocomplete="customer_phone" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="source_name" type="text"
                                                                    ...
                                                                    name="source_name"
                                                                    value="{{ old('source_name', $service->source_name) }}"
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="source_phone" type="text"
                                                                    ...
                                                                    name="source_phone"
                                                                    value="{{ old('source_phone', $service->source_phone) }}"
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input id="source_address" type="text"
                                                                    ...
                                                                    name="source_address"
                                                                    value="{{ old('source_address', $service->source_address) }}"
                                                                    required autocomplete="source_address" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="destination_name" type="text"
                                                                    ...
                                                                    value="{{ old('destination_name', $service->destination_name) }}"
                                                                    required autocomplete="destination_name" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="destination_phone" type="text"
                                                                    ...
                                                                    value="{{ old('destination_phone', $service->destination_phone) }}"
                                                                    required autocomplete="destination_phone" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input id="destination_address" type="text"
                                                                    ...
                                                                    value="{{ old('destination_address', $service->destination_address) }}"
                                                                    required autocomplete="destination_address" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-3">
                                                                <select id="parcel_type" name="parcel_type"
                                                                    ...
                                                                    <option value="พัสดุ"
                                                                        @if (old('parcel_type', $service->parcel_type) == 'พัสดุ') {{ 'selected' }} @endif>
                                                                        พัสดุ</option>
                                                                    <option value="เอกสาร"
                                                                        @if (old('parcel_type', $service->parcel_type) == 'เอกสาร') {{ 'selected' }} @endif>
                                                                        เอกสาร</option>
                                                                </select>
                                                                @error('parcel_type')
                                                                    <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="parcel_weight" type="text"
                                                                    ...
                                                                    name="parcel_weight"
                                                                    value="{{ old('parcel_weight', $service->parcel_weight) }}"
                                                                    required autocomplete="parcel_weight" autofocus>
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="parcel_size" type="text"
                                                                    ...
                                                                    name="parcel_size"
                                                                    value="{{ old('parcel_size', $service->parcel_size) }}"
                                                ...
                                                <div class="card card-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row mb-1">
                                                            <label for="bikerid" class="col-md-5 text-md-right">เลขที่เอกสาร #</label>
                                                            <div class="col-md-4">
                                                                <label class="text-md-right">{{ $service->id }}</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="date_pickup" type="datetime-local"
                                                                    ...
                                                                    name="date_pickup"
                                                                    value="{{ old('date_pickup', $service->date_pickup) }}"
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input id="date_deliver" type="datetime-local"
                                                                    ...
                                                                    name="date_deliver"
                                                                    value="{{ old('date_deliver', $service->date_deliver) }}"
                                                        ...
                                                        <div class="form-group row mb-1">
                                                            ...
                                                            <div class="col-md-7">
                                                                <select id="pay_type" name="pay_type"
                                                                    class="form-control"
                                                                    aria-label="Default select example">
                                                                    <option value="เก็บเงินต้นทาง"
                                                                        @if (old('pay_type', $service->pay_type) == 'เก็บเงินต้นทาง') {{ 'selected' }} @endif>
                                                                        เก็บเงินต้นทาง</option>
                                                                    <option
                                                                        value="ปลายทาง"@if (old('pay_type', $service->pay_type) == 'ปลายทาง') {{ 'selected' }} @endif>
                                                                        ปลายทาง</option>
                                                                </select>
                                                                @error('pay_type')
                                                                    <span class="invalid-feedback" role="alert">
                                                            ...
                                                            <div class="col-md-7">
                                                                <select name="biker_id" class="form-control"
                                                                    ...
                                                                    @foreach ($bikers as $biker)
                                                                        <option value="{{ $biker->id }}"
                                                                            {{ $biker->id == $service->biker_id ? 'selected' : '' }}>รหัส
                                                                            {{ $biker->id }} :
                                                                ...
                                                                <select name="doctype_id" class="form-control"
                                                                    ...
                                                                    @foreach ($doctypes as $doctype)
                                                                        <option value="{{ $doctype->id }}"
                                                                            {{ $doctype->id == $service->doctype_id ? 'selected' : '' }}>
                                                                            {{ $doctype->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('doctype_id')
                                ...
                                <div class="card-footer">
                                    <div class="col-sm-12">
                                        <form action="{{ route('services.destroy', $service->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger">ลบข้อมูลนี้</button>
                                        </form>
                                    </div>
                                </div>
